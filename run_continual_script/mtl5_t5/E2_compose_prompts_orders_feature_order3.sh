...
# with contrastive learning 20 epoch
...
python3 src/run_continual_mtl5_t5_feature.py \
    ...
    --pre_seq_len $psl \
    --output_dir checkpoints_continual_mtl5_t5/contrastive_order3_E2_compose_prompts \
